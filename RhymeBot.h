...
private:
	struct Dict{
		int isvoid;
			vector<Sound> spelling;
		};
	map<string,vector<Sound>> mydic ;
	map<string, Dict> dict;
	map<string,PART_OF_SPEECH > mypar ;
...
public:
    ...
    vector<string>* getAllRhymes_Part(string word111111111);
    ...
    vector<string>* getAllAlliterations_Part(string word);
